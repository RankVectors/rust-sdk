...
pub struct PagePricing {
    ...
    pub tiers: Option<Vec<models::PagePricingTiersInner>>,
    #[serde(rename = "pagePacks", skip_serializing_if = "Option::is_none")]
    pub page_packs: Option<Vec<models::PagePricingPagePacksInner>>,
}

impl PagePricing {
    pub fn new() -> PagePricing {
        PagePricing {
            tiers: None,
            page_packs: None,
        }
