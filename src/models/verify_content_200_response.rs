...
pub struct VerifyContent200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "verification", skip_serializing_if = "Option::is_none")]
    pub verification: Option<Box<models::ContentVerification>>,
}

impl VerifyContent200Response {
    pub fn new() -> VerifyContent200Response {
