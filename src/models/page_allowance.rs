...
pub struct PageAllowance {
    #[serde(rename = "allowance", skip_serializing_if = "Option::is_none")]
    pub allowance: Option<Box<models::PageAllowanceInfo>>,
    #[serde(rename = "usageHistory", skip_serializing_if = "Option::is_none")]
    pub usage_history: Option<Vec<models::PageAllowanceUsageHistoryInner>>,
}

impl PageAllowance {
    pub fn new() -> PageAllowance {
        PageAllowance {
            allowance: None,
            usage_history: None,
        }
