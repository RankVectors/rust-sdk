...
pub struct PageAllowanceUsageHistoryInner {
    #[serde(rename = "date", skip_serializing_if = "Option::is_none")]
    pub date: Option<String>,
    #[serde(rename = "pagesIndexed", skip_serializing_if = "Option::is_none")]
    pub pages_indexed: Option<i32>,
}

impl PageAllowanceUsageHistoryInner {
    pub fn new() -> PageAllowanceUsageHistoryInner {
