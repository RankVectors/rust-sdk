...
pub struct UsageHistoryItem {
    ...
    #[serde(rename = "pagesAffected", skip_serializing_if = "Option::is_none")]
    pub pages_affected: Option<i32>,
    /// Usage timestamp
...
impl UsageHistoryItem {
    pub fn new(id: String, action: String, created_at: String) -> UsageHistoryItem {
        UsageHistoryItem {
            id,
            action,
            pages_affected: None,
