...
pub struct ImplementationResponse {
    ...
    pub results: Vec<models::ImplementationResult>,
    #[serde(rename = "summary")]
    pub summary: Box<models::ImplementationSummary>,
}

impl ImplementationResponse {
    pub fn new(success: bool, results: Vec<models::ImplementationResult>, summary: models::ImplementationSummary) -> ImplementationResponse {
