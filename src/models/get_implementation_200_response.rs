...
pub struct GetImplementation200Response {
    #[serde(rename = "success", skip_serializing_if = "Option::is_none")]
    pub success: Option<bool>,
    #[serde(rename = "implementation", skip_serializing_if = "Option::is_none")]
    pub implementation: Option<Box<models::Implementation>>,
}

impl GetImplementation200Response {
    pub fn new() -> GetImplementation200Response {
