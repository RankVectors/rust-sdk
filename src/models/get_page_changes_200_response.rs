...
pub struct GetPageChanges200Response {
    #[serde(rename = "changes", skip_serializing_if = "Option::is_none")]
    pub changes: Option<Vec<models::PageChange>>,
    #[serde(rename = "summary", skip_serializing_if = "Option::is_none")]
    pub summary: Option<Box<models::GetPageChanges200ResponseSummary>>,
}

impl GetPageChanges200Response {
    pub fn new() -> GetPageChanges200Response {
