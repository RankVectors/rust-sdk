...
pub struct PageAllowanceInfo {
    /// Total pages allowed (tier + packs)
    #[serde(rename = "pagesTotal")]
    pub pages_total: i32,
    /// Pages currently indexed across all projects
    #[serde(rename = "pagesUsed")]
    pub pages_used: i32,
    /// Remaining pages before upgrade or page pack
    #[serde(rename = "pagesRemaining")]
    pub pages_remaining: i32,
}

impl PageAllowanceInfo {
    pub fn new(pages_total: i32, pages_used: i32, pages_remaining: i32) -> PageAllowanceInfo {
        PageAllowanceInfo {
            pages_total,
            pages_used,
            pages_remaining,
