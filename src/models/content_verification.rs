...
pub struct ContentVerification {
    ...
    #[serde(rename = "reason")]
    pub reason: String,
    #[serde(rename = "changeResult", skip_serializing_if = "Option::is_none")]
    pub change_result: Option<Box<models::ChangeResult>>,
}

impl ContentVerification {
    pub fn new(safe: bool, reason: String) -> ContentVerification {
        ContentVerification {
            safe,
            reason,
            change_result: None,
