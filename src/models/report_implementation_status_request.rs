...
pub struct ReportImplementationStatusRequest {
...
impl ReportImplementationStatusRequest {
    pub fn new(suggestion_id: String, api_key: String, status: Status) -> ReportImplementationStatusRequest {
