...
pub struct StepByStepInstructions {
    /// Step-by-step instructions
    #[serde(rename = "steps")]
    pub steps: Vec<String>,
    /// HTML example of the implementation
    #[serde(rename = "htmlExample")]
    pub html_example: String,
}

impl StepByStepInstructions {
    pub fn new(steps: Vec<String>, html_example: String) -> StepByStepInstructions {
